function checkWindow(){
	...
	if(w >= 1000){
		...
		$("#logo img").attr("src","Assets/Images/metrimart-logo-white.svg");
		$("#cart img").attr("src","Assets/Images/icon-shopping-cart-white.svg");
		$("#siteMap").html("\
		...
		$("#logo img").attr("src","Assets/Images/icon-metrimart.svg");
		$("#cart img").attr("src","Assets/Images/icon-shopping-cart.svg");
		$("#siteMap").html("\
			<a title='Go to privacy policy page' href='#'>privacy policy</a> | \
			<a title='Go to terms &amp; conditions page' href='#'>terms &amp; conditions</a> | \
